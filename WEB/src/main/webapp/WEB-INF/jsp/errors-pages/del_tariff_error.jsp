...
<fmt:message bundle="${loc}" key="local.error_page.del_tariff_header"
	var="del_tariff_header" />
<fmt:message bundle="${loc}" key="local.error_page.del_tariff_text"
	var="del_tariff_text" />
