...
<fmt:message key="local.reg_header" var="header_text" />
<fmt:message key="local.reg_form" var="reg_form" />
<fmt:message key="local.required" var="required" />
<fmt:message key="local.first_name" var="first_name" />
<fmt:message key="local.last_name" var="last_name" />
<fmt:message key="local.passport" var="passport" />
<fmt:message key="local.email" var="email" />
<fmt:message key="local.login" var="login" />
<fmt:message key="local.password" var="password" />
<fmt:message key="local.rep_password" var="rep_password" />
<fmt:message key="local.back_button" var="back_button" />
<fmt:message key="local.register_button" var="register_button" />
<fmt:message key="local.first_name_hint" var="first_name_hint" />
<fmt:message key="local.last_name_hint" var="last_name_hint" />
<fmt:message key="local.passport_hint" var="passport_hint" />
<fmt:message key="local.email_hint" var="email_hint" />
<fmt:message key="local.login_hint" var="login_hint" />
<fmt:message key="local.password_hint" var="password_hint" />
<fmt:message key="local.rep_password_hint" var="rep_password_hint" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<!-- CONTENT -->
	<div class="content">
		<form class="reg_form" action="Controller" method="post" onchange="return validateForm()" name="RegForm">
			<ul>
				<li>
