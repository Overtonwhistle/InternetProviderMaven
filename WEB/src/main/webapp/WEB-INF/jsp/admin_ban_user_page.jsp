...
<fmt:message bundle="${loc}" key="local.admin_block_users_page.reason_ballance"
		var="reason_ballance" />
...
<fmt:message bundle="${loc}" key="local.admin_block_users_page.block_user_button"
		var="block_user_button" />
<fmt:message bundle="${loc}" key="local.admin_block_users_page.blocking_text" var="blocking_text" />
<fmt:message bundle="${loc}" key="local.admin_block_users_page.unblock_user_button"
				...
				<form action="Controller" method="post" class="reg_form">
						<ul>
								...
								<c:if test="${requestScope.is_blocked ne true}">
										<li><label>${reason_field}:</label><select style="margin-left: 0px;" size="1"
												name="ban_reason">
