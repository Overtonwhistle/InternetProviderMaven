function validateForm() {
	...
	BAD_PASSPORT = " *incorrect passport number",
	BAD_EMAIL = " *incorrect e-mail", 
	BAD_LOGIN = " *incorrect login", 
	WEAK_PASSWORD = " *weak password", 
	PWD_NOT_EQUAL = " *passwords do not match";
	...
	var first_name = document.RegForm.firstname.value, last_name = document.RegForm.lastname.value, passport = document.RegForm.passport.value, email = document.RegForm.email.value, login = document.RegForm.login.value, pwd1 = document.RegForm.pwd1.value, pwd2 = document.RegForm.pwd2.value;
