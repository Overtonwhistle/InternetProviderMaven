...
public class GotoAdminRequests implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute(ATTRIBUTE_REQUESTS_LIST, requestsList);
		request.setAttribute(ATTRIBUTE_TARIFFS_LIST, tariffsList);
		request.setAttribute(ATTRIBUTE_USERS_LIST, usersList);
		request.setAttribute(ATTRIBUTE_ADMINS_NAMES_LIST, adminsNamesList);
		request.setAttribute(ATTRIBUTE_TARIFFS_NAMES_LIST, tariffsNamesList);
