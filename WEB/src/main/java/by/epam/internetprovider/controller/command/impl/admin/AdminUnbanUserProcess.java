...
public class AdminUnbanUserProcess implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			internetProviderService.unbanUser((int) session.getAttribute(ATTRIBUTE_ID_TO_WORK));
		} catch (ServiceException e) {
			logger.log(Level.ERROR, "Failed to edit user data in command:AdminUnbanUserProcess");
			throw new CommandException("Error executing command:AdminUnbanUserProcess", e);
		}
