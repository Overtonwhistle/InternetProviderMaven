...
import static by.epam.internetprovider.dao.searchfilter.queryConstant.REQUEST_BY_USER_SUBQUERY;

import by.epam.internetprovider.dao.searchfilter.ISubFilterCommand;
import by.epam.internetprovider.dao.searchfilter.SubFilter;

public class RequestByUser implements ISubFilterCommand {
	...
	public void execute(StringBuilder query, SubFilter subfilter) {
		...
		query.append(REQUEST_BY_USER_SUBQUERY);
