/**
 * @author Pavel Sorokoletov source code see here
...
public class PasswordComputer {

	@Test
	public void hashTesting() throws CannotPerformOperationException, InvalidHashException {
		String hash = (createHash("123qweQ"));
		Assert.assertTrue(verifyPassword("123qweQ",
				"sha1:64000:18:UAnrDFLcNr70xhQjMO5evBW9DdaL8HwN:ZxtQiZW0ThZvJ+4BHwZGXuID"));
		Assert.assertTrue(verifyPassword("123qweQ", hash));
	}
